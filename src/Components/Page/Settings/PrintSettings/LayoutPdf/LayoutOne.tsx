...
export default function LayoutThree({ title, data }: LayoutProps) {
  // Added Number() casting to prevent math errors if data arrives as strings
  const invoiceData = {
        ...
        <View style={styles.container}>
          ...
          <View style={styles.companySection}>
            ...
            <View style={styles.companyDetails}>
              <Text style={{ fontSize: 16, fontWeight: "bold" }}>
                {data?.user_name || "Dev First"}
              </Text>
              <Text>Email: {data?.email || "devteam6090@gmail.com"}</Text>
            </View>
          </View>
          ...
          <View style={styles.infoBar}>
            <View style={styles.infoCol}>
              ...
              <Text>{data?.user_name || "Customer"}</Text>
            </View>
          ...
          {data?.items?.map((item: subItem, index: number) => (
            <View style={styles.tableRow} key={index}>
              ...
              <Text style={styles.col6}>{item.price}</Text>
            </View>
          ))}
          ...
          <View style={styles.summaryContainer}>
            ...
            <View style={styles.summaryRight}>
              ...
              <View style={{ padding: 4 }}>
                ...
                <Text style={{ fontSize: 8 }}>Balance: {invoiceData?.due}</Text>
              </View>
            </View>
          </View>
